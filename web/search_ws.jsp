...
<f:view>
    <h:form id="searchForm">
        ...
        <h:inputText id="searchTerm" value="#{searchWs.searchTerm}"/>
        <p>Choose your endpoint:</p>
        <h:inputText id="serviceEndpoint" value="#{searchWs.serviceEndpoint}"/>
        <h:commandButton type="submit" value="Enter"
            action="#{searchWs.handleSubmitEnter}"/>
    </h:form>

    <f:subview id="searchResult" rendered="#{searchWs.hasSearchResult}">
        <hr/>
        <p>
            You shall find it here:
        </p>
        <h:dataTable
                 value="#{searchWs.searchResult}" var="entry"
                 styleClass="jar"
